...
\begin{enumerate}
    \item Tree-based gradient boosting outperforms GNNs and deep learning architectures on heterogeneous tabular datasets with dense scalar lag features.

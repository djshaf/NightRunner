...
export interface Summary {
  ...
  length: number;
  cost: number;
  // Injected by our safety-reranking proxy (see safety_score.py). Optional
  // since a request that bypasses the reranker won't have these.
  safety_score?: number;
  pct_length_near_risky?: number;
  worst_tag_encountered?: number | null;
}
